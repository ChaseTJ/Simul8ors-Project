...
class WindFarmSimulator:
    ...
    def add_description(self):
        ...
        s2 = "Choose your desired wind speed, direction, and turbine placement to see how your farm will perform! Left-click(place a turbine); right-click (undo the last placement). `W`, `A`, `S`, `D` (panning). Mouse wheel (zooming on the cursor). Scale Bar Selection(`Space` + 2x Clicks). Convert to meters: print turbine coordinates in meters ."
        description1 = tk.Label(self.control_frame, text=s1, wraplength=280, justify="left", bg="lightgray")
        description1.pack(pady=5, anchor="w")
        description2 = tk.Label(self.control_frame, text=s2, wraplength=280, justify="left", bg="lightgray")
    ...
    def add_dropdowns(self):
        ...
        # Wind Speed Dropdown
        label_speed = tk.Label(self.control_frame, text="Select Wind Speed (km/h):", bg="lightgray")
        ...
        label_direction = tk.Label(self.control_frame, text="Select Wind Direction:", bg="lightgray")
        ...
        label_d = tk.Label(self.control_frame, text="Turbine Type (rated power, MW):", bg="lightgray")
